        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              然后再打开
              <ExternalLink href="https://www.bing.com/turing/captcha/challenge">Challenge 验证</ExternalLink>
              右键 检查 打开开发者工具，在网络里面找到 Challenge 属性 右键复制 复制为 cURL(bash)，粘贴到此处，然后保存。
              <div className="h-2" />
              图文示例：
